...
class MarkdownParserTest {
    ...
    fun testHemingwayAnalyzer() {
        ...
        val metrics = com.attachdesign.kern.analysis.HemingwayAnalyzer.analyze(text)
        ...
        val complexHighlights = metrics.highlights.filter { it.type == com.attachdesign.kern.analysis.HighlightType.COMPLEX_WORD }
