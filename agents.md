...
* **No Custom UI Controls:** Never write custom UI controls or components if an existing Material 3 (M3) or Material 3 Expressive (M3E) control can fulfill the required functionality.
