...
This folder is the shared context for maintainers, contributors, and AI coding assistants. Read the relevant guide before changing product behavior, Android code, or the public website.
...
- [Web standards](web-standards.md) — static-site structure, content, accessibility, metadata, and deployment expectations.

Supporting contributor documentation remains in the repository root and `docs/`:
